# Generated by Django 4.1.1 on 2022-09-07 16:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='essesntials.articleseries', verbose_name='Series')),
            ],
            options={
